...
const DICT = {
  ...
  "validation.pairStat": { zh: "單一參數 A/B 效果組", en: "single-parameter A/B effect pairs" },
  ...
  "validation.method3": { zh: "固定場景、攝影機與燈光，只改一個參數後由 EEVEE 渲染，確認每組結果確實有像素差異。", en: "Hold scene, camera and lighting fixed, vary one parameter, and render in EEVEE to verify a real pixel difference for each pair." },
