...
const DICT = {
  ...
  "meta.tutorials.title": { zh: "引導教學 · Blender 5.2 LTS 材質節點", en: "Guided Tutorials · Blender 5.2 LTS Material Nodes" },
  "meta.tutorials.description": {
    zh: "跟著步驟做出玻璃、金屬、木紋等 Blender 5.2 LTS 材質，每一步都有提示與自動驗證。",
    en: "Build glass, metal, wood, and more with Blender 5.2 LTS material nodes. Every guided step includes hints and automatic validation.",
  },
