...
const DICT = {
  ...
  "sandbox.mobileNotice": {
    zh: "節點編輯器需要滑鼠拖曳操作，畫面空間也比較吃緊，建議改用桌面電腦或平板橫向以取得完整體驗。",
    en: "The node editor relies on mouse dragging and needs more screen space than this. For the full experience, please switch to a desktop computer or a tablet in landscape mode.",
  },
