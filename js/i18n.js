...
const DICT = {
  ...
  "a11y.hintIcon": { zh: "名詞說明", en: "Term explanation" },
  "a11y.deleteStop": { zh: "刪除停駐點", en: "Delete stop" },
  "a11y.deleteCurvePoint": { zh: "刪除控制點", en: "Delete control point" },
  "a11y.deleteNode": { zh: "刪除節點", en: "Delete node" },
  "a11y.colorSwatch": { zh: "選擇顏色", en: "Choose color" },
  "a11y.livePreview": { zh: "即時 3D 材質預覽", en: "Live 3D material preview" },
